...
topics: List[TopicDescriptor] = [
    ...
    # ---- AC Load (per-phase) ----
    TopicDescriptor(
        topic="N/+/acload/+/Ac/{phase}/Voltage",
        message_type=MetricKind.SENSOR,
        short_id="acload_voltage_{phase}",
        name="ACLoad voltage on {phase}",
        unit_of_measurement="V",
        metric_type=MetricType.VOLTAGE,
        metric_nature=MetricNature.INSTANTANEOUS,
        device_type=DeviceType.ACLOAD,
        value_type=ValueType.FLOAT,
        precision=1,
    ),
    TopicDescriptor(
        topic="N/+/acload/+/Ac/{phase}/Current",
        message_type=MetricKind.SENSOR,
        short_id="acload_current_{phase}",
        name="ACLoad current on {phase}",
        unit_of_measurement="A",
        metric_type=MetricType.CURRENT,
        metric_nature=MetricNature.INSTANTANEOUS,
        device_type=DeviceType.ACLOAD,
    ...
    TopicDescriptor(
        topic="N/+/acload/+/Ac/{phase}/Power",
        message_type=MetricKind.SENSOR,
        short_id="acload_power_{phase}",
        name="ACLoad power on {phase}",
        unit_of_measurement="W",
        metric_type=MetricType.POWER,
        metric_nature=MetricNature.INSTANTANEOUS,
        device_type=DeviceType.ACLOAD,
    ...
    TopicDescriptor(
        topic="N/+/acload/+/Ac/{phase}/Energy/Forward",
        message_type=MetricKind.SENSOR,
        short_id="acload_energy_forward_{phase}",
        name="ACLoad consumption on {phase}",
        unit_of_measurement="kWh",
        metric_type=MetricType.ENERGY,
        metric_nature=MetricNature.CUMULATIVE,
        device_type=DeviceType.ACLOAD,
    ...
    TopicDescriptor(
        topic="N/+/acload/+/Ac/{phase}/Energy/Reverse",
        message_type=MetricKind.SENSOR,
        short_id="acload_energy_reverse_{phase}",
        name="ACLoad feed-in on {phase}",
        unit_of_measurement="kWh",
        metric_type=MetricType.ENERGY,
        metric_nature=MetricNature.CUMULATIVE,
        device_type=DeviceType.ACLOAD,
    ...
    TopicDescriptor(
        topic="N/+/acload/+/Ac/{phase}/VoltageLineToLine",
        message_type=MetricKind.SENSOR,
        short_id="acload_voltage_{phase}_{next_phase}",
        name="ACLoad voltage {phase} to {next_phase}",
        unit_of_measurement="V",
        metric_type=MetricType.VOLTAGE,
        metric_nature=MetricNature.INSTANTANEOUS,
        device_type=DeviceType.ACLOAD,
    ...
    # ---- AC Load (non-phase) ----
    TopicDescriptor(
        topic="N/+/acload/+/Ac/PENVoltage",
        message_type=MetricKind.SENSOR,
        short_id="acload_voltage_pen",
        name="ACLoad voltage on PEN",
        unit_of_measurement="V",
        metric_type=MetricType.VOLTAGE,
        metric_nature=MetricNature.INSTANTANEOUS,
        device_type=DeviceType.ACLOAD,
    ...
    TopicDescriptor(
        topic="N/+/acload/+/Ac/N/Current",
        message_type=MetricKind.SENSOR,
        short_id="acload_current_n",
        name="ACLoad current on N",
        unit_of_measurement="A",
        metric_type=MetricType.CURRENT,
        metric_nature=MetricNature.INSTANTANEOUS,
        device_type=DeviceType.ACLOAD,
    ...
    TopicDescriptor(
        topic="N/+/acload/+/Ac/Frequency",
        message_type=MetricKind.SENSOR,
        short_id="acload_frequency",
        name="ACLoad frequency",
        unit_of_measurement="Hz",
        metric_type=MetricType.FREQUENCY,
        metric_nature=MetricNature.INSTANTANEOUS,
        device_type=DeviceType.ACLOAD,
    ...
    TopicDescriptor(
        topic="N/+/acload/+/Ac/Energy/Forward",
        message_type=MetricKind.SENSOR,
        short_id="acload_energy_forward",
        name="ACLoad consumption",
        unit_of_measurement="kWh",
        metric_type=MetricType.ENERGY,
        metric_nature=MetricNature.CUMULATIVE,
        device_type=DeviceType.ACLOAD,
    ...
    TopicDescriptor(
        topic="N/+/acload/+/Ac/Energy/Reverse",
        message_type=MetricKind.SENSOR,
